...
class Bot:
    ...
    def _get_updates(self):
        ...
        try:
            ...
            if data["result"]:
                self.last_update = data["result"][-1][
                    "update_id"
                ]  # storing last update id
    ...
    def send_message(self, chat_id, text, parse_mode="MarkdownV2", reply_markup=None):
        ...
        parameters = {"chat_id": chat_id, "text": text, "parse_mode": parse_mode}
    ...
    def update_message(
        self, chat_id, message_id, text, parse_mode="MarkdownV2", reply_markup=None
    ):
...
class Conversation:
    ...
    def go_to_step(self, step):
        if step == 0:
            ...
            log.error(f"No step named {step} defined, staying at current step")
...
class ReplyKeyboardMarkup:
    ...
    def __init__(
        self, keyboard, resize_keyboard=False, one_time_keyboard=False, selective=False
    ):
        self.data = {
...
class InlineKeyboardMarkup:
    ...
    def __init__(self, keyboard):
        self.data = {"inline_keyboard": [[k.data for k in row] for row in keyboard]}
...
class InlineKeyboardButton:
    ...
    def __init__(self, text, url="", callback_data=""):
        self.data = {"text": text, "url": url, "callback_data": callback_data}
